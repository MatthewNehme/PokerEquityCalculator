...
# Source files
SOURCES = main.cpp Card.cpp Player.cpp Community.cpp Deck.cpp Generate.cpp PokerGame.cpp HandStrength.cpp

# Object files (automatically generated from source files)
OBJECTS = $(SOURCES:.cpp=.o)

# Header files (for dependency tracking)
HEADERS = Card.hpp Player.hpp Community.hpp Deck.hpp Generate.hpp PokerGame.hpp HandStrength.hpp
